...
export function UpcomingAppointments({ upcomingAppointments }: { upcomingAppointments: UpcomingAppointment[] }) {
  return (
    <section className="dashboard-panel appointments-panel" aria-labelledby="upcoming-title">
      ...
      <div className="table-scroll">
        ...
        {upcomingAppointments.length === 0 && <div className="dashboard-empty-row">Nenhum agendamento programado.</div>}
      </div>
    </section>
  );
}
