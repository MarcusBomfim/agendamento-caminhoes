...
export const carrierOptions = ["Rota Litoral", "Transmar Logística", "Costa Transportes", "Eixo Sul Cargas", "Navega Log"];
...
export const terminalOptions = ["Terminal Atlântico", "Pátio Alemoa", "Terminal Guarujá"];
export const gateOptions = ["Portão 01", "Portão 02", "Portão 03", "Portão 04"];
